...
from PySide6.QtCore import (QCoreApplication, QMetaObject, QRect, QRegularExpression)
from PySide6.QtWidgets import (QButtonGroup, QCheckBox, QDoubleSpinBox,
    ...
    QWidget, QAbstractItemView, QTabWidget, QVBoxLayout, QLineEdit)
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        # self.central_widget.resize(958, 686)
        self.tabs = QTabWidget(self.central_widget)
        self.tabs.resize(958, 686)
        self.simulation_widget = QWidget()
        # self.simulation_widget.setGeometry(0, 0, 1000, 1000)
        # self.simulation_widget.setLayout(QVBoxLayout())
        self.simulation_widget.setObjectName(u"centralwidget")
        self.graphicsView_CA = QTableWidget(self.central_widget)
        self.graphicsView_CA.setObjectName(u"graphicsView_CA")
        self.graphicsView_CA.setGeometry(QRect(540, 80, 300, 300))
        ...
        self.pushButton_states = QPushButton(self.central_widget)
        ...
        self.pushButton_strategies = QPushButton(self.central_widget)
        ...
        self.pushButton_kD = QPushButton(self.central_widget)
        ...
        self.pushButton_kC = QPushButton(self.central_widget)
        ...
        self.pushButton_kDC = QPushButton(self.central_widget)
        ...
        self.pushButton_actions = QPushButton(self.central_widget)
        ...
        # LA group
        self.groupBox_LA = QGroupBox(self.simulation_widget)
        self.groupBox_LA.setGeometry(QRect(370, 100, 150, 100))
        self.groupBox_LA.setEnabled(False)

        # LA checkbox
        self.checkBox_LA = QCheckBox(self.simulation_widget)
        self.checkBox_LA.setGeometry(QRect(380, 80, 100, 20))
        self.checkBox_LA.toggled.connect(self.groupBox_LA.setEnabled)

        self.label_memoryh = QLabel(self.groupBox_LA)
        ...
        self.groupBox_simul = QGroupBox(self.simulation_widget)
        ...
        self.spinBox_custom_seed.setValidator(QRegularExpressionValidator("[0-9]*", self.groupBox_seed))
        ...
        # self.spinBox_custom_seed.setMaximum(sys.maxsize)
        ...
        self.spinBox_u = QSpinBox(self.groupBox_simul)
        self.spinBox_u.setObjectName(u"spinBox_u")
        self.spinBox_u.setGeometry(QRect(220, 480, 91, 22))
        self.spinBox_u.setMaximum(100)
        self.spinBox_u.setMinimum(1)
        self.spinBox_u.setValue(1)
        self.label_u = QLabel(self.groupBox_simul)
        self.label_u.setGeometry(QRect(210, 480, 10, 22))
        ...
        self.spinBox_optimal_num_1s.setMaximum(1000000)
        self.spinBox_optimal_num_1s.setValue(676)
        self.label = QLabel(self.central_widget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(50, 535, 91, 16))
        self.label_2 = QLabel(self.central_widget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(110, 550, 81, 16))
        self.radiobutton_pay_fun_1 = QRadioButton(self.central_widget)
        self.radiobutton_pay_fun_1.setObjectName(u"pay_fun_1")
        self.radiobutton_pay_fun_1.setGeometry(QRect(240, 535, 81, 16))
        self.radiobutton_pay_fun_1.setChecked(True)
        self.radiobutton_pay_fun_2 = QRadioButton(self.central_widget)
        self.radiobutton_pay_fun_2.setObjectName(u"pay_fun_2")
        self.radiobutton_pay_fun_2.setGeometry(QRect(240, 555, 81, 16))
        self.groupBox_payoff = QGroupBox(self.central_widget)
        self.groupBox_payoff.setObjectName(u"groupBox_payoff")
        self.groupBox_payoff.setGeometry(QRect(50, 580, 181, 71))
        self.button_group_payoff = QButtonGroup(self.central_widget)
        ...
        self.label_15 = QLabel(self.simulation_widget)
        self.label_15.setObjectName(u"label_15")
        self.label_15.setGeometry(QRect(540, 50, 49, 16))

        self.lcdNumber_iters = QLCDNumber(self.central_widget)
        self.lcdNumber_iters.setObjectName(u"lcdNumber_iters")
        self.lcdNumber_iters.setGeometry(QRect(590, 50, 51, 21))

        self.label_27 = QLabel(self.central_widget)
        self.label_27.setObjectName(u"label_27")
        self.label_27.setGeometry(QRect(90, 560, 49, 21))
        self.label_28 = QLabel(self.central_widget)
        self.label_28.setObjectName(u"label_28")
        self.label_28.setGeometry(QRect(30, 590, 21, 21))
        self.label_29 = QLabel(self.central_widget)
        self.label_29.setObjectName(u"label_29")
        self.label_29.setGeometry(QRect(170, 560, 49, 21))
        self.label_30 = QLabel(self.central_widget)
        self.label_30.setObjectName(u"label_30")
        self.label_30.setGeometry(QRect(30, 620, 49, 21))
        self.label_31 = QLabel(self.central_widget)
        self.label_31.setObjectName(u"label_31")
        self.label_31.setGeometry(QRect(0, 600, 49, 31))
        # self.label_32 = QLabel(self.centralwidget)
        # self.label_32.setObjectName(u"label_32")
        # self.label_32.setGeometry(QRect(620, 50, 49, 16))
        self.pushButton_start_anim = QPushButton(self.central_widget)
        self.pushButton_start_anim.setObjectName(u"pushButton_start_anim")
        self.pushButton_start_anim.setGeometry(QRect(630, 400, 61, 21))
        self.pushButton_start_anim.clicked.connect(MainWindow.start_animation_thread)
        self.spinBox_iters = QSpinBox(self.central_widget)
        self.spinBox_iters.setObjectName(u"spinBox_iters")
        self.spinBox_iters.setGeometry(QRect(560, 400, 61, 25))
        self.spinBox_iters.setMaximum(1000)
        self.spinBox_iters.setValue(0)
        self.label_33 = QLabel(self.central_widget)
        self.label_33.setObjectName(u"label_33")
        self.label_33.setGeometry(QRect(510, 400, 51, 20))
        self.pushButton_stop = QPushButton(self.central_widget)
        self.pushButton_stop.setObjectName(u"pushButton_stop")
        self.pushButton_stop.setGeometry(QRect(700, 400, 61, 21))
        ...
        self.pushButton_save.setGeometry(QRect(770, 400, 81, 21))
        self.pushButton_save.clicked.connect(MainWindow.saveImage)
        self.graphicsView_gnuplot = QGraphicsView(self.central_widget)
        ...
        # self.line_2.setGeometry(QRect(370, 440, 651, 20))
        # self.line_2.setFrameShape(QFrame.HLine)
        # self.line_2.setFrameShadow(QFrame.Sunken)
        self.pushButton_start = QPushButton(self.simulation_widget)
        ...
        self.nash_widget = QWidget()
        self.groupBox_nash = QGroupBox(self.nash_widget)
        self.groupBox_nash.setObjectName(u"groupBox_simul")
        self.groupBox_nash.setGeometry(QRect(10, 0, 361, 511))
        self.spinBox_cols = QSpinBox(self.groupBox_nash)
        self.spinBox_cols.setObjectName(u"spinBox_Ncols")
        self.spinBox_cols.setGeometry(QRect(60, 60, 61, 25))
        self.spinBox_cols.setValue(3)
        self.spinBox_cols.setMaximum(999)
        self.label_24_1 = QLabel(self.groupBox_nash)
        self.label_24_1.setObjectName(u"label_24")
        self.label_24_1.setGeometry(QRect(10, 30, 51, 21))
        self.label_23_1 = QLabel(self.groupBox_nash)
        self.label_23_1.setObjectName(u"label_23")
        self.label_23_1.setGeometry(QRect(10, 60, 49, 21))
        self.spinBox_rows = QSpinBox(self.groupBox_nash)
        self.spinBox_rows.setObjectName(u"spinBox_Mrows")
        self.spinBox_rows.setGeometry(QRect(60, 30, 61, 25))
        self.spinBox_rows.setValue(3)
        self.spinBox_rows.setMaximum(999)

        self.label_2 = QLabel(self.central_widget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(110, 550, 81, 16))

        self.radioButton_check_sol = QRadioButton(self.groupBox_nash)
        self.radioButton_check_sol.setObjectName(u"check_sol")
        self.radioButton_check_sol.setGeometry(QRect(10, 90, 180, 40))
        self.radioButton_check_sol.setChecked(True)

        self.groupBox_read_CA_state = QGroupBox(self.groupBox_nash)
        self.groupBox_read_CA_state.setObjectName(u"groupBox_debug")
        self.groupBox_read_CA_state.setEnabled(False)
        self.groupBox_read_CA_state.setGeometry(QRect(10, 140, 340, 61))
        self.radioButton_plus_delta = QCheckBox(self.groupBox_read_CA_state)
        self.radioButton_plus_delta.setObjectName(u"radioButton_plus_delta")
        self.radioButton_plus_delta.setGeometry(QRect(10, 10, 200, 22))
        self.radioButton_minus_delta = QCheckBox(self.groupBox_read_CA_state)
        self.radioButton_minus_delta.setObjectName(u"radioButton_minus_delta")
        self.radioButton_minus_delta.setGeometry(QRect(10, 30, 200, 22))
        self.radioButton_read = QCheckBox(self.groupBox_nash)
        self.radioButton_read.setObjectName(u"radioButton_read")
        self.radioButton_read.setGeometry(QRect(10, 120, 200, 22))
        self.radioButton_read.toggled.connect(self.groupBox_read_CA_state.setEnabled)
        self.label_plus_delta = QLabel(self.groupBox_read_CA_state)
        self.label_plus_delta.setGeometry(QRect(180, 10, 100, 22))
        self.label_minus_delta = QLabel(self.groupBox_read_CA_state)
        self.label_minus_delta.setGeometry(QRect(180, 30, 100, 22))
        self.spinBox_plus = QSpinBox(self.groupBox_read_CA_state)
        self.spinBox_plus.setGeometry(QRect(250, 10, 61, 25))
        self.spinBox_plus.setValue(100)
        self.spinBox_plus.setMaximum(999)
        self.spinBox_minus = QSpinBox(self.groupBox_read_CA_state)
        self.spinBox_minus.setGeometry(QRect(250, 30, 61, 25))
        self.spinBox_minus.setValue(100)
        self.spinBox_minus.setMaximum(999)

        self.radioButton_save_last_plus = QCheckBox(self.groupBox_nash)
        self.radioButton_save_last_plus.setGeometry(QRect(10, 205, 200, 22))
        self.radioButton_save_last_minus = QCheckBox(self.groupBox_nash)
        self.radioButton_save_last_minus.setGeometry(QRect(10, 225, 200, 22))


        self.pushButton_start_2 = QPushButton(self.nash_widget)
        self.pushButton_start_2.setGeometry(QRect(240, 560, 111, 71))
        self.pushButton_start_2.clicked.connect(MainWindow.start_nash)


        # tabs
        self.tabs.addTab(self.simulation_widget, "Simulation")
        self.tabs.addTab(self.nash_widget, "Nash Equilibrium")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_24_1.setText(QCoreApplication.translate("MainWindow", u"M rows:", None))
        self.label_23_1.setText(QCoreApplication.translate("MainWindow", u"N cols:", None))
        ...
        self.groupBox_nash.setTitle(QCoreApplication.translate("MainWindow", u"Parameters:", None))
        self.radioButton_plus_delta.setText(QCoreApplication.translate("MainWindow", u"check_plus_delta_solut", None))
        self.radioButton_minus_delta.setText(QCoreApplication.translate("MainWindow", u"check_minus_delta_solut", None))
        self.radioButton_read.setText(QCoreApplication.translate("MainWindow", u"read CA_state", None))
        self.radioButton_save_last_plus.setText(QCoreApplication.translate("MainWindow", u"read last CA_state_plus", None))
        self.radioButton_save_last_minus.setText(QCoreApplication.translate("MainWindow", u"read last CA_state_minus", None))
        self.label_plus_delta.setText(QCoreApplication.translate("MainWindow", u"plus_delta:", None))
        self.label_minus_delta.setText(QCoreApplication.translate("MainWindow", u"minus_delta:", None))

        self.radioButton_check_sol.setText(QCoreApplication.translate("MainWindow", u"check_all_solution 2^(M*N)", None))
        ...
        self.checkBox_LA.setText(QCoreApplication.translate("MainWindow", u"LA", None))
        ...
        self.label_u.setText(QCoreApplication.translate("MainWindow", u"u:", None))
        ...
        self.pushButton_start_2.setText(QCoreApplication.translate("MainWindow", u"START", None))
